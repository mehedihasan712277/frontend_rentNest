...
import { Payment, PaymentStatus, usePaymentStore } from "@/store/paymentStore";
    ...
    return (
        <div className="space-y-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        {filteredPayments.length} of {paymentsCount} payment
                        {paymentsCount === 1 ? "" : "s"} shown
                    </p>
                </div>
            ...
            <div className="rounded-md border">
                ...
                <div className="hidden border-b bg-muted/50 px-4 py-2 text-xs font-medium text-muted-foreground md:grid md:grid-cols-[2fr_1.5fr_1.5fr_1fr_1fr_1fr]">
                    <span>Property</span>
                    <span>Landlord</span>
                    <span>Tenant</span>
                    <span>Status</span>
                ...
                <div className="divide-y">
                    {isLoadingPayments && payments.length === 0 ? (
                        ...
                        filteredPayments.map((payment) => (
                            <div
                                key={payment.id}
                                className="flex flex-col gap-3 px-4 py-3 md:grid md:grid-cols-[2fr_1.5fr_1.5fr_1fr_1fr_1fr] md:items-center md:gap-2"
                            >
                                {/* Property */}
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="truncate text-sm">
                                        {payment.rental.property.landlord.name}
                                    </span>
                                </div>
