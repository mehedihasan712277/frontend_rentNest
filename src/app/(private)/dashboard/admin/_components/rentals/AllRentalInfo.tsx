...
import { RentalInfo, RentalStatus, useRentalStore } from "@/store/rentalStore";
...
const AllRentalInfo = () => {
    const { rentals, isLoadingRentals, rentalsError, fetchAllRentals } =
        useRentalStore();
    ...
    const filteredRentals: RentalInfo[] = useMemo(() => {
    ...
    return (
        <div className="space-y-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 className="text-xl font-semibold">All Rentals</h2>
                    <p className="text-sm text-muted-foreground">
                        {filteredRentals.length} of {rentals.length} rental
                        {rentals.length === 1 ? "" : "s"} shown
                    </p>
                </div>
            ...
            <div className="rounded-md border">
                ...
                <div className="hidden border-b bg-muted/50 px-4 py-2 text-xs font-medium text-muted-foreground md:grid md:grid-cols-[2.5fr_1.5fr_1.5fr_1fr_1.5fr_1fr]">
                    <span>Property</span>
                    <span>Landlord</span>
                    <span>Tenant</span>
                    <span>Status</span>
                ...
                <div className="divide-y">
                    {isLoadingRentals && rentals.length === 0 ? (
                        ...
                        filteredRentals.map((rental) => (
                            <div
                                key={rental.id}
                                className="flex flex-col gap-3 px-4 py-3 md:grid md:grid-cols-[2.5fr_1.5fr_1.5fr_1fr_1.5fr_1fr] md:items-center md:gap-2"
                            >
                                {/* Property */}
